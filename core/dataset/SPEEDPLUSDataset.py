...
class SPEEDPLUSDataset(torch.utils.data.Dataset):
    ...
    def __init__(self,
        ...
        self.output_size = [int(s / cfg.DATASET.MASK_RATIO) for s in self.input_size]
        ...
        self.imagefolder = f'images_{self.input_size[0]}x{self.input_size[1]}_RGB'  # 'images_768x512_RGB'
        self.maskfolder  = f'masks_{self.output_size[0]}x{self.output_size[1]}' # 'masks_96x64'
        self.stylefolder = f'styles_{self.input_size[0]}x{self.input_size[1]}_RGB' #'styles_768x512_RGB'
