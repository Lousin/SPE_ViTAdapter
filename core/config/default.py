...
# Basic settings
# ------------------------------------------------------------------------------ #
_C.ROOT       = '/root/shangqi/code/spe_rwkv'       # Root directory of this project (.../spe_rwkv)
...
_C.DATASET.ROOT      = '/root/shangqi/data'                 # Root directory of all datasets
...
_C.DATASET.HEATMAP_RATIO = 8                                # Heatmap size [W, H]
_C.DATASET.MASK_RATIO    = 8                                # Mask size [W, H] for segmentation
...
_C.MODEL.BACKBONE.NAME = 'spe_rwkv'                      # Name of the backbone: 'vision_rwkv'
_C.MODEL.BACKBONE.PRETRAINED = None                         # Pre-trained model for the backbone only
_C.MODEL.BACKBONE.RWKV = CN()

_C.MODEL.BACKBONE.RWKV.encoder =CN()
_C.MODEL.BACKBONE.RWKV.encoder.num_layers = 6
_C.MODEL.BACKBONE.RWKV.encoder.hidden_size = 256
_C.MODEL.BACKBONE.RWKV.encoder.norm_first = True
_C.MODEL.BACKBONE.RWKV.encoder.norm_bias = True
_C.MODEL.BACKBONE.RWKV.encoder.norm_eps = 1e-5
_C.MODEL.BACKBONE.RWKV.encoder.attn_mode = "chunk"
_C.MODEL.BACKBONE.RWKV.encoder.expand_k = 1
_C.MODEL.BACKBONE.RWKV.encoder.expand_v = 1
_C.MODEL.BACKBONE.RWKV.encoder.num_heads = 8
_C.MODEL.BACKBONE.RWKV.encoder.proj_low_rank_dim = 32
_C.MODEL.BACKBONE.RWKV.encoder.gate_low_rank_dim = 64
_C.MODEL.BACKBONE.RWKV.encoder.fuse_norm = True
_C.MODEL.BACKBONE.RWKV.encoder.hidden_ratio = 3.5
_C.MODEL.BACKBONE.RWKV.encoder.hidden_act = "sqrelu"
_C.MODEL.BACKBONE.RWKV.encoder.use_cache = False
_C.MODEL.BACKBONE.RWKV.encoder.drop_path_rate = 0.5

_C.MODEL.BACKBONE.RWKV.feat_size = [96,64]
_C.MODEL.BACKBONE.RWKV.feature_layers=[0,1,2]
_C.MODEL.BACKBONE.EXTRA = CN(new_allowed=True)


# - Heads
_C.MODEL.HEAD = CN()
_C.MODEL.HEAD.DEPTH = 4
_C.MODEL.HEAD.NUM_ITER = 2                                  # Number of classes to predict
